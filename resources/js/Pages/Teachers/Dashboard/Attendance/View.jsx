...
export default function TeacherAttendanceViewPage({ auth, classroom, attendance, date }) {
    ...
    const handleDateSubmit = () => {
        router.visit(`/teacher/dashboard/attendance/${classroom.id}/attendance?date=${date}`);
    };
    const handleExportSubmit = () => {
        window.location.href = `/teacher/dashboard/attendance/${classroom.id}/export?date=${date}`;
    };
                        ...
                        <div className="mx-auto px-4 sm:px-6 md:px-14 mt-6">
                            <DataTable
                                ...
                                buttons={[{
                                    ...
                                    show: (row) => row.status.props.children !== t.attendance_not_taken,
                                }]}
                            />
